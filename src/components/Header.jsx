                    ...
                    <div className="header">
                        <div className="logo-or-nav">
                            ...
                            <div className="nav">
                                <NavLink
                                    to='home'
                                    className={`nav-main btn-style ${activeTab === 'home' ? 'active' : ''}`}
                                ...
                                >
                                    ...
                                    >
                                        <path
                                            ...
                                            stroke={activeTab === 'home' ? '#FFFFFF' : '#ADADAD'}
                                            strokeWidth="2"
                                        />
                                        <path
                                ...
                                >
                                    ...
                                    >
                                        <path
                                            ...
                                            stroke={activeTab === 'donate' ? '#FFFFFF' : '#ADADAD'}
                                            strokeWidth="2"
                                            strokeLinecap="round"
                                            strokeLinejoin="round"
                                        />
                                ...
                                >
                                    ...
                                    >
                                        <path
                                            ...
                                            stroke={activeTab === 'servers' ? '#FFFFFF' : '#ADADAD'}
                                            strokeWidth="2"
                                        />
                                        <path
                                            className={activeTab === 'servers' ? 'active' : ''}
